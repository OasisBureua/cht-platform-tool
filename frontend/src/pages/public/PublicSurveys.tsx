              ...
              <div className="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-center">
                ...
                <div className="min-w-0">
                  ...
                  <div className="mt-3 flex flex-wrap items-center gap-2 sm:gap-3">
                    <Link
                      to="/app/surveys"
                      className="inline-flex min-h-[40px] min-w-[44px] items-center justify-center gap-2 rounded-md bg-brand-600 px-4 py-2 text-sm font-bold text-white shadow-[0_1px_0_0_rgba(255,255,255,0.12)_inset,0_8px_24px_-10px_rgba(0,124,255,0.45)] transition-[background-color,transform,box-shadow] duration-200 ease-[cubic-bezier(0.2,0,0,1)] hover:bg-brand-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-500 active:scale-[0.96]"
                    >
