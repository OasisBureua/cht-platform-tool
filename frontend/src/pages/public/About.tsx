        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-8 sm:py-12 grid grid-cols-1 lg:grid-cols-12 gap-10">
          <div className="lg:col-span-7 space-y-6">
              ...
              <ul className="space-y-5">
                {CORE_PILLARS.map(({ title, body }) => (
                  <li key={title}>
                    ...
                    <p className="mt-1 text-base text-gray-600 leading-relaxed">{body}</p>
                  </li>
                ))}
              </ul>
            ...
            <div className="pt-2 space-y-4">
              <h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-gray-900">Formats we deliver</h2>
              <p className="text-base md:text-lg text-gray-600 leading-relaxed">
          ...
          <div className="lg:col-span-5">
            <div className="rounded-3xl border border-gray-200 bg-gray-50 p-8 space-y-5 lg:sticky lg:top-24">
              <p className="text-base font-semibold text-gray-900">Explore the platform</p>
              ...
              <div className="space-y-3">
                <Link
                  to="/catalog"
                  className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-gray-900 px-7 py-3 text-base font-semibold text-white hover:bg-black"
                >
                  Browse Catalogue <ArrowRight className="h-4 w-4" />
                </Link>
                <Link
                  to="/join"
                  className="inline-flex w-full items-center justify-center rounded-full border border-gray-200 bg-white px-7 py-3 text-base font-semibold text-gray-900 hover:bg-gray-50"
                >
                  Get started
                </Link>
              </div>
