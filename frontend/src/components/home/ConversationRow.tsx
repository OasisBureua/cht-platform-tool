      ...
      <div className="mb-3 flex flex-wrap items-end justify-between gap-2">
        ...
        {seeAllExternal ? (
          <a
            ...
            className="inline-flex min-h-[44px] min-w-0 items-center gap-1.5 rounded-lg px-1 text-sm font-semibold text-accent-700 transition-[color,transform] duration-200 ease-[cubic-bezier(0.2,0,0,1)] hover:text-accent-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-600 sm:min-h-0 sm:px-0 active:scale-[0.96] dark:text-accent-400 dark:hover:text-accent-300"
          >
