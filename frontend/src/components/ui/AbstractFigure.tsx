 ...
 * ends.
 *
 * Ported from chm-composio's `abstract-figure.tsx`. The beams behind
 * the drawing reach for `--color-beam` / `--color-pink`, which the
 * compatibility layer in index.css declares.
 */
...
function Conversation() {
  return (
    <g fill="none" stroke={ink} strokeLinecap="round" strokeLinejoin="round">
      ...
      <path
        d="M330 430 C 358 372, 386 404, 408 366 C 430 330, 458 400, 482 372"
        strokeWidth="1.8"
        opacity="0.8"
      />
