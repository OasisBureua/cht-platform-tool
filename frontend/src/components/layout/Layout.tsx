...
export default function Layout() {
  ...
  return (
    <div className="app-shell flex min-h-screen min-w-0 flex-col bg-chm-surface text-foreground md:flex-row dark:bg-zinc-950 dark:text-zinc-100">
      <AppSidebar />
      <AppBottomNav />

      <div
        className="relative flex min-h-0 min-w-0 flex-1 basis-0 flex-col overflow-hidden bg-chm-surface dark:bg-zinc-950 max-md:bg-[#18181b] md:overflow-visible"
        onClick={(e) => {
          if (!mobileDrawerOpen) return;
      ...
      >
        ...
        >
                  ...
                  className={({ isActive }) =>
                    [
                      ...
                      isActive
                        ...
                        : 'text-foreground hover:bg-steel-50/90 hover:text-zinc-950 dark:text-zinc-100 dark:hover:bg-zinc-800/85 dark:hover:text-white',
                    ].join(' ')
                  }
                >
                  {({ isActive }) => (
          ...
          <div className="mt-auto border-t border-zinc-200 px-4 py-3 text-[11px] leading-snug text-muted-foreground dark:border-zinc-800 dark:text-muted-foreground">
            <Link
              to="/app/settings"
        ...
        <div
          ...
          className={[
            ...
            'relative z-[1] flex min-h-[100dvh] flex-1 flex-col bg-muted motion-reduce:transition-none md:min-h-0 md:rounded-none md:shadow-none dark:bg-zinc-950',
            mobileDrawerOpen
          ...
          <header className="nav-liquid-glass sticky top-0 z-30 flex h-14 shrink-0 items-center justify-between gap-2 px-4 sm:h-16 sm:px-6 lg:px-8">
            <div className="flex min-w-0 flex-1 items-center gap-2 pr-2 md:gap-3 md:pr-3">
              ...
              <div className="min-w-0 flex-1">
                <h1 className="truncate text-lg font-bold tracking-tight text-foreground dark:text-zinc-50 md:text-xl">
                  Welcome, {displayName}!
                </h1>
                ...
                {profileMenuOpen ? (
                  ...
                  >
                    <button
                      ...
                      className="flex min-h-[44px] w-full items-center rounded-[6px] px-3 text-left text-sm font-medium text-muted-foreground transition-[background-color,color] duration-200 ease-out hover:bg-muted hover:text-foreground md:hidden dark:text-zinc-200 dark:hover:bg-zinc-800 dark:hover:text-zinc-100"
                    >
