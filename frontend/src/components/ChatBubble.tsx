...
export default function ChatBubble() {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setOpen((v) => !v)}
        className="fixed bottom-4 right-4 z-[70] flex h-14 w-14 items-center justify-center rounded-full bg-accent text-white shadow-[0_6px_20px_-6px_rgba(234,88,12,0.55)] transition-[transform,background-color,box-shadow] hover:bg-accent-hover active:scale-95 dark:bg-accent dark:hover:bg-accent"
